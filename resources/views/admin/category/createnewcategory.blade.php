            ...
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
                        <h4 class="fw-semibold fs-18 mb-sm-0">Create Home Content</h4>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel" aria-labelledby="preview-tab" tabindex="0">
                            <form method="POST" action="{{url('admin/category')}}" role="form" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <select name="type" class="form-control text-dark">
                                                    ...
                                                    <option value="11" {{ old('type') == '11' ? 'selected' : '' }}>Counter Section 11</option>
                                                </select>
                                                @if($errors->any())
                                    ...
                                    <div class="col-lg-12 mt-5">
                                        ...
                                        <div id="multiple-entries">
                                            @for ($i = 0; $i < 6; $i++) <div class="entry-row row mb-4" style="border: 1px solid #007bff; padding: 10px; border-radius: 5px; background-color: #e9ecef;">
                                                <div class="col-md-4">
