                    ...
                    <div class="card-header">
                        <section class="content-header">
                            <div class="container-fluid">
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <!-- <h1><a href="{{url('admin/category/create')}}" class="btn btn-primary float-left">Add New
                                                Category</a>
                                        </h1> -->
                                    </div>
                                    <div class="col-sm-6">
                    ...
                    <div class="card-body tblscrollbar">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 border-right">
                                <form method="post" action="{{url('admin/locations')}}" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    @csrf
                                    <div class="row">
                                ...
                                <tr>
                                    ...
                                    <!-- <td>
                                        <div class="switch switch-success d-inline m-r-10">
                                            <input id="switch-s-{{$list->id}}" type="checkbox" class="DepartmentStatus btn btn-success" name="" rel="{{$list->id}}" data-toggle="toggle" data-on="Enable" data-of="Disable" data-onstyle="success" data-offstyle="danger" @if($list->status=="0")
                                            checked @endif>
