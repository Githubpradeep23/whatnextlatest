            ...
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
                        <h4 class="fw-semibold fs-18 mb-sm-0">Edit Gallery</h4>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel" aria-labelledby="preview-tab" tabindex="0">
                            <form method="POST" action="{{url('admin/gallery/' . $editGallery->id)}}" role="form" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="text" name="title" value="{{old('title',$editGallery->title)}}" class="form-control text-dark {{ ($errors->any() && $errors->first('title')) ? 'is-invalid' : '' }}" placeholder="Title">
                                                @if($errors->any())
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <img src="{{asset('gallery/'.$editGallery->image)}}" alt="" style="width: 50px; height:50px;">
                                            <div class="form-group position-relative">
                                                <input type="file" name="image" data-default-file="{{asset('gallery/'.$editGallery->image)}}" id="image" class="dropify" data-height="100" data-max-file-size="3M" data-allowed-file-extensions='["jpg", "png","jpeg"]' />
                                                <input type="hidden" name="old_image" value="{{old('name',$editGallery->image)}}">
                                                @if($errors->any())
