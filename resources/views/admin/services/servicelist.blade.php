            ...
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
                        <h4 class="fw-semibold fs-18 mb-sm-0">Service List</h4>
                    ...
                    <div class="default-table-area recent-orders">
                        <div class="table-responsive">
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    @php $number = ($ServiceList->currentpage()-1)* $ServiceList->perpage() + 1;@endphp
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>@if(!empty($list->image))<img src="{{asset('service/'.$list->image)}}" alt="" style="width: 50px; height:50px;">@else <img src="{{asset('assets/backend/admin/empty.png')}}" alt="" style="width: 50px; height:50px;"> @endif</td>
                                        ...
                                        <td>
                                            <div class="dropdown action-opt">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ url('admin/service/details/' . $list->id ) }}">
                                                            <i data-feather="eye"></i>
                                                            Detail
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ url('admin/service/' . $list->id . '/edit') }}">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form method="POST" action="{{ url('admin/service/' . $list->id) }}" role="form" enctype="multipart/form-data" class="form-horizontal">
                                                            @csrf
                                                            @method('delete')
                        ...
                        <div class="d-sm-flex justify-content-between align-items-center text-center">
                            <span class="fs-14">Showing {{ $ServiceList->firstItem() }} To {{ $ServiceList->lastItem() }} Of {{$ServiceList->total()}} Entries</span>
