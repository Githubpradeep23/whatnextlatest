                        ...
                        <div class="table-responsive">
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    ...
                                    @forelse($pagesEntry as $key => $list)

                                    <tr class="text-center">
                                        <th scope="row">{{ $number }}</th>
                                        <td>{{ substr(strip_tags($list->title), 0, 40) }}...</td>
                                        <td>@if(!empty($list->image))<img src="{{asset('pages/'.$list->image)}}" alt="" style="width: 50px; height:50px;">@else <img src="{{asset('assets/admin/empty.png')}}" alt="" style="width: 50px; height:50px;"> @endif</td>
                                        ...
                                        <td>
                                            <div class="dropdown action-opt">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ url('admin/pages/' . $list->page_id . '/edit?'.$pageId) }}">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form method="POST" action="{{ url('admin/pages/details/destroy/' . $list->id) }}" role="form" enctype="multipart/form-data" class="form-horizontal">
                                                            @csrf
                                                            @method('post')
