            ...
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
                        <h4 class="fw-semibold fs-18 mb-sm-0">Create Banner</h4>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel" aria-labelledby="preview-tab" tabindex="0">
                            <form method="POST" action="{{url('admin/banner')}}" role="form" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <div class="form-group position-relative">
                                                <textarea name="short_description" id="editor" class="form-control text-dark {{ $errors->has('short_description') ? 'is-invalid' : '' }}" placeholder="Short Description" cols="30" rows="10">{{ old('short_description') }}</textarea>
