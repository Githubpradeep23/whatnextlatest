            ...
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
                        <h4 class="fw-semibold fs-18 mb-sm-0">Banner List</h4>
                        <a href="{{url('admin/banner/create')}}" class="border-0 btn btn-primary py-2 px-3 px-sm-4 text-white fs-14 fw-semibold rounded-3">
                    ...
                    <div class="default-table-area recent-orders">
                        <div class="table-responsive">
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    @php $number = ($BannerList->currentpage()-1)* $BannerList->perpage() + 1;@endphp

                                    @forelse($BannerList as $key => $list)

                                    <tr class="text-center">
                                        <th scope="row">{{ $number }}</th>
                                        <td>{{ substr(strip_tags($list->title), 0, 40) }}...</td>
                                        <td>@if(!empty($list->image))<img src="{{asset('banner/'.$list->image)}}" alt="" style="width: 50px; height:50px;">@else <img src="{{asset('assets/admin/empty.png')}}" alt="" style="width: 50px; height:50px;"> @endif</td>
                                        ...
                                        <td>
                                            <div class="dropdown action-opt">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end bg-white border box-shadow">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ url('admin/banner/' . $list->id . '/edit') }}">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form method="POST" action="{{ url('admin/banner/' . $list->id) }}" role="form" enctype="multipart/form-data" class="form-horizontal">
                                                            @csrf
                                                            @method('delete')
                        ...
                        <div class="d-sm-flex justify-content-between align-items-center text-center">
                            <span class="fs-14">Showing {{ $BannerList->firstItem() }} To {{ $BannerList->lastItem() }} Of {{$BannerList->total()}} Entries</span>
