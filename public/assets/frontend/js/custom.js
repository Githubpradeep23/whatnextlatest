...
$(document).ready(function () {
    ...
    //                     easing: "swing",
    //                     step: function (now) {
    //                         // Change this to control the number of decimal places
    ...
    //                     easing: "swing",
    //                     step: function (now) {
    //                         // Ensure only the required number of decimal places is shown
    //                         if (finalValue % 1 !== 0) {
    //                             // check if it's a floating-point number
    //                             $this.text(now.toFixed(1)); // show one decimal place
    //                         } else {
    //                             $this.text(Math.ceil(now)); // show integer
    //                         }
    //                     },
    //                 }
    //             );
    ...
    $(".count-element").each(function () {
        $(this).appear(
            function () {
                ...
                var suffix = originalText.replace(/[0-9.]/g, ""); // Extract non-numeric part as suffix
                ...
                $this.prop("Counter", 0).animate(
                    ...
                    },
                    {
                        ...
                        step: function (now) {
                            if (finalValue % 1 !== 0) {
                                $this.text(now.toFixed(1) + suffix); // Show one decimal place with suffix
                            } else {
                                $this.text(Math.ceil(now) + suffix); // Show integer with suffix
                            }
                        },
                    }
                );
